...
- (void)viewDidLoad {
    ...
    [self.textLabel setText:[NSString stringWithFormat:@"%@\n%@\n%@\n%@\n%@",NSLocalizedString(@"laws_text_1", nil),  NSLocalizedString(@"laws_text_2", nil), NSLocalizedString(@"laws_text_3", nil), NSLocalizedString(@"laws_text_4", nil), NSLocalizedString(@"laws_text_6", nil)]];
